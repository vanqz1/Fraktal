...
namespace WindowsFormsApplication3
{
    public partial class Form1 : Form
    {
        ...
        private void Draw(object sender, EventArgs e)
        {
            ...
            var point1 = new PointF(float.Parse(this.textBox1.Text), float.Parse(this.textBox2.Text));
            var point2 = new PointF(float.Parse(this.textBox3.Text), float.Parse(this.textBox4.Text));
            var point3 = new PointF(float.Parse(this.textBox5.Text), float.Parse(this.textBox6.Text));
